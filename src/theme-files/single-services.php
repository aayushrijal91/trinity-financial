...
<div class="inner_service">
    ...
    <?php if (!empty($header['title'])) : ?>
        <div class="header">
            <div class="container">
                ...
                <div class="fs-21 pt-6 pb-7 description"><?= $header['description'] ?></div>
                <a href="<?= $header['button']['url'] ?>" class="btn btn-primary fs-21 rounded-0 py-4 px-6 fw-600"><?= $header['button']['title'] ?></a>
            </div>
        </div>
    <?php endif; ?>
    ...
    <?php if (!empty($footer['image']['url'])) : ?>
        <div class="footer">
            <img src="<?= $footer['image']['url'] ?>" alt="frames" class="w-100">
            <div class="inner">
                <div class="container-fluid">
