    ...
    <div class="container">
        <div class="quick-links">
            <div class="row justify-content-lg-between gy-5">
                <div class="col-md-6 col-lg-3 col-xl-3 order-1">
                ...
                <div class="col-md-9 col-lg-5 col-xl-4 order-4 order-xl-3">
                ...
                <div class="col-6 col-md-3 col-lg-2 col-xl-auto order-3 order-xl-4">
        ...
        <div class="footer-bottom">
            <div class="row justify-content-center justify-content-xl-between align-items-center gy-4">
                <div class="col-auto col-md-12 col-xl-auto">
                    <div class="fs-14 text-center text-xl-start"><?= get_field('footer', 'options')['copyright'] ?></div>
                </div>
                <div class="col-auto">
