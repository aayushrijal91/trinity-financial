...
<div class="homepage">
    <section class="section_1">
        ...
        <div class="container">
            <div class="row gx-4">
                <div class="col-7">
                    <div class="fs-75 lh-1_2"><?= $section_1['heading'] ?></div>
                    <div class="row justify-content-end mt-9">
                        <div class="col-8">
                            <div class="fs-37"><?= $section_1['sub_heading'] ?></div>
                            <div class="text-center pt-7"><a href="<?= $section_1['button']['url'] ?>" class="btn btn-primary fs-21 rounded-0 py-4 px-5 fw-600"><?= $section_1['button']['title'] ?></a></div>
                        </div>
                    </div>
                </div>
                <div class="col-5">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="fs-23 lh-1_87 py-6 description"><?= $section_2['description'] ?></div>
