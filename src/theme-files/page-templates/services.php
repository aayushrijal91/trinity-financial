        ...
        <div class="row gy-6 gx-xl-5">
            ...
            if ($the_query->have_posts()) :
                while ($the_query->have_posts()) :
                    ...
                    if (get_field('banner')['sub_heading'] && strlen(get_field('banner')['sub_heading']) > 100) {
                        $featured_description = substr(get_field('banner')['sub_heading'], 0, 100) . '...';
                    } else {
                        $featured_description = get_field('banner')['sub_heading'];
                    }
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="service_card">
                            ...
                            <div class="content">
                                ...
                                <div class="fs-13 ls-2 fw-300 py-3"><?= $featured_description ?></div>
